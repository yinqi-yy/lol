...
function _M.create(callBackProvider)
	...
	setValue(obj, "Scene", nil, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Scene_0 = obj

	obj = ccui.ImageView:create()
	roots.Scene_0:addChild(obj)
	roots.root.Image_1 = obj
	setValue(obj, "Image_1", 715, cc.size(1334, 750), cc.p(668.2468, 373.7416), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_4", 722, cc.size(41, 43), cc.p(1164.6565, 718.5616), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_5", 723, cc.size(41, 43), cc.p(1252.9338, 718.0869), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_2", 716, cc.size(1223, 592), cc.p(686.9258, 293.8071), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Register", 717, cc.size(232, 50), cc.p(418.5428, 504.3177), nil, nil, nil, nil, false)
	obj:loadTextureNormal("mianfeizhuce.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	obj:setTitleFontSize(14)
	bind(obj).setMargin(302.5428, 62.6823, 688.4573, 479.3177)

	obj = ccui.Button:create()
	roots.Image_2_1:addChild(obj)
	obj:setCapInsets(cc.rect(15, 11, 202, 28))
	roots.root.Button_2 = obj
	setValue(obj, "Button_2", 718, cc.size(232, 50), cc.p(774.0723, 504.3185), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_3", 719, cc.size(254, 54), cc.p(591.4661, 243.1187), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_3", 720, cc.size(351, 40), cc.p(662.814, 411.2048), nil, nil, nil, nil, false)
	...
	setValue(obj, "TextField_1", 724, cc.size(337.0133, 32.0924), cc.p(166.9901, 20.2443), nil, nil, nil, nil, false)
	obj:setString([[]])
	obj:setPlaceHolder([[]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_4", 721, cc.size(351, 40), cc.p(662.6521, 345.9048), nil, nil, nil, nil, false)
	obj:loadTexture("denglu/dl_shuruk.png", 0)
	...
	setValue(obj, "TextField_1_0", 725, cc.size(337.0133, 32.0924), cc.p(167.1552, 24.1198), nil, nil, nil, nil, false)
	obj:setString([[]])
	obj:setPlaceHolder([[]])
	obj:setFontSize(20)
	bind(obj).setMargin(-1.3515, -0.166, 15.3382, 8.0736)
