...
function _M.create(callBackProvider)
	...
	setValue(obj, "Image_LobbyBg", 84, cc.size(1334, 727), cc.p(667.6188, 343.2351), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_roomInfoBg", 863, cc.size(1334, 502), cc.p(668.0438, 364.7429), nil, nil, nil, nil, false)
	obj:loadTexture("fangjian/fangjian_bj.png", 0)
	bind(obj).setMargin(1.0438, 111.2571, -1.0437, 113.7429)
	...
	setValue(obj, "Button_Spot", 35, cc.size(196, 52), cc.p(1209.9851, 267.3111), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_QuickStart", 879, cc.size(196, 52), cc.p(1210.77, 393.8519), nil, nil, nil, nil, false)
	...
	setValue(obj, "Text_room#", 37, cc.size(38, 26), cc.p(117.1761, 415.3848), nil, nil, nil, nil, nil)
	obj:setString([[001]])
	obj:setFontSize(20)
	bind(obj).setMargin(98.1761, 73.6152, 1197.824, 402.3848)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_AvgReturn = obj
	setValue(obj, "Text_AvgReturn", 38, cc.size(56, 26), cc.p(372.7715, 414.5154), nil, nil, nil, nil, nil)
	obj:setString([[2,567]])
	obj:setFontSize(20)
	...
	setValue(obj, "Text_BiggestWin", 39, cc.size(80, 26), cc.p(726.6852, 417.0107), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[234,567]])
	obj:setFontSize(20)
	bind(obj).setMargin(686.9706, 73.6438, 567.0294, 402.3562)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_room#_0 = obj
	setValue(obj, "Text_room#_0", 42, cc.size(38, 26), cc.p(116.2468, 364.021), nil, nil, nil, nil, nil)
	obj:setString([[002]])
	obj:setFontSize(20)
	bind(obj).setMargin(97.2468, 124.979, 1198.7532, 351.021)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_AvgReturn_0 = obj
	setValue(obj, "Text_AvgReturn_0", 43, cc.size(57, 26), cc.p(371.8727, 363.9018), nil, nil, nil, nil, nil)
	obj:setString([[1,234]])
	obj:setFontSize(20)
	bind(obj).setMargin(343.3727, 125.0982, 933.6273, 350.9018)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWin_0 = obj
	setValue(obj, "Text_BiggestWin_0", 44, cc.size(80, 26), cc.p(727.1633, 365.5582), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[678,902]])
	obj:setFontSize(20)
	bind(obj).setMargin(687.4487, 125.0963, 566.5513, 350.9037)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWininLevel1 = obj
	setValue(obj, "Text_BiggestWininLevel1", 45, cc.size(152, 26), cc.p(474.2052, 64.5095), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_TotalNumofPpl", 46, cc.size(39, 26), cc.p(858.4287, 68.3268), nil, nil, nil, nil, nil)
	obj:setString([[234]])
	obj:setFontSize(20)
	bind(obj).setMargin(838.9287, 420.6732, 456.0713, 55.3268)

	obj = ccui.ImageView:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Image_Level = obj
	setValue(obj, "Image_Level", 36, cc.size(153, 38), cc.p(1219.6611, 521.5032), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_upperbar", 864, cc.size(1334, 46), cc.p(667.2248, 725.3325), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_4", 82, cc.size(351, 40), cc.p(682.7983, -52.9748), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Button_IngameMessage", 83, cc.size(24, 21), cc.p(276.0958, -54.6474), nil, nil, nil, nil, false)
	...
	obj = ccui.Text:create()
	roots.Image_upperbar_1:addChild(obj)
	roots.root.Text_11 = obj
	setValue(obj, "Text_11", 85, cc.size(507, 26), cc.p(627.7129, -52.5462), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Panel_lowerbar", 873, cc.size(1319.6129, 100.8273), cc.p(668.5653, 13.3469), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
