...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 818, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_2 = obj
	setValue(obj, "Image_2", 819, cc.size(1255, 668), cc.p(676.404, 378.3017), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_1", 820, cc.size(1140, 469), cc.p(628.7117, 291.2231), nil, nil, nil, nil, false)
	obj:loadTexture("bangzhu4.png", 0)
	bind(obj).setMargin(58.7117, 142.2769, 56.2883, 56.7231)

	obj = ccui.Button:create()
	roots.Image_2_1:addChild(obj)
	obj:setCapInsets(cc.rect(5, 4, 7, 6))
	roots.root.Button_1 = obj
	setValue(obj, "Button_1", 821, cc.size(17, 14), cc.p(1212.0463, 638.1484), cc.p(0.4403, 0.6791), nil, nil, nil, false)
	obj:setScale(2, 2)
