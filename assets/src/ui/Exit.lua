...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 20, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.Layout:create()
	roots.Layer_0:addChild(obj)
	roots.root.Panel_bg = obj
	setValue(obj, "Panel_bg", 21, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	...
	setValue(obj, "Image_bg", 22, cc.size(429, 350), cc.p(667, 375), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_ok", 23, cc.size(112, 44), cc.p(114.9353, 35.8664), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_cancel", 24, cc.size(112, 42), cc.p(313.3405, 35.8663), nil, nil, nil, nil, false)
	...
	setValue(obj, "Text_des", 25, cc.size(234, 36), cc.p(215, 188), nil, cc.c4b(139, 105, 20, 255), nil, nil, nil)
	obj:setString([[是否退出游戏?]])
	obj:setFontSize(36)
