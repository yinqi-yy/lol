...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 740, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_bg = obj
	setValue(obj, "Image_bg", 759, cc.size(1334, 750), cc.p(666.4734, 375.7466), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Level1", 753, cc.size(253, 300), cc.p(141.8585, 426.3591), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Level3", 760, cc.size(253, 300), cc.p(824.4116, 426.561), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Level4", 761, cc.size(268, 300), cc.p(1175.5493, 426.561), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Level2", 762, cc.size(253, 300), cc.p(473.2648, 426.5596), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_upperBar", 743, cc.size(1334, 46), cc.p(666.7601, 733.5908), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 742, cc.size(41, 43), cc.p(975.9916, 28.4973), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 744, cc.size(33, 29), cc.p(65.7158, 28.0958), cc.p(0.6082, 0.6533), nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 745, cc.size(41, 43), cc.p(1044.1061, 25.5364), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 747, cc.size(41, 43), cc.p(1109.1421, 22.5624), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 748, cc.size(41, 43), cc.p(1242.9402, 22.5624), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 749, cc.size(41, 43), cc.p(1178.7494, 22.5624), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 751, cc.size(122, 40), cc.p(60.3604, -27.467), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_bank", 752, cc.size(57, 74), cc.p(167.4861, -30.0727), cc.p(0.4185, 0.5675), nil, nil, nil, false)
	...
	setValue(obj, "Panel_lowerbar", 763, cc.size(1319.6129, 100.8273), cc.p(662.3427, 56.0139), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
	...
	setValue(obj, "Button_daily", 754, cc.size(77, 73), cc.p(1194.4596, 53.895), cc.p(0.5013, 0.5246), nil, nil, nil, false)
	...
	setValue(obj, "Button_Competition", 755, cc.size(75, 82), cc.p(200.5307, 56.1186), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_SystemNotice", 756, cc.size(76, 79), cc.p(309.9258, 56.1193), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_VIP", 757, cc.size(75, 76), cc.p(54.6709, 53.4179), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_wealth", 758, cc.size(84, 77), cc.p(1043.2777, 52.593), cc.p(0.5322, 0.4804), nil, nil, nil, false)
