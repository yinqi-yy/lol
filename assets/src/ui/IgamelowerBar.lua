...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 824, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.Layout:create()
	roots.Layer_0:addChild(obj)
	roots.root.Panel_lowerbar = obj
	setValue(obj, "Panel_lowerbar", 825, cc.size(1319.6129, 100.8273), cc.p(662.3427, 56.0139), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
	...
	setValue(obj, "Button_daily", 826, cc.size(77, 73), cc.p(1194.4596, 53.895), cc.p(0.5013, 0.5246), nil, nil, nil, false)
	...
	setValue(obj, "Button_Competition", 827, cc.size(75, 82), cc.p(200.5307, 56.1186), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_SystemNotice", 828, cc.size(76, 79), cc.p(309.9258, 56.1193), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_VIP", 829, cc.size(75, 76), cc.p(54.6709, 53.4179), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_wealth", 830, cc.size(84, 77), cc.p(1043.2777, 52.593), cc.p(0.5322, 0.4804), nil, nil, nil, false)
