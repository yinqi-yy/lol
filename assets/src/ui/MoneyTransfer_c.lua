...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 177, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_BankingFrame = obj
	setValue(obj, "Image_BankingFrame", 180, cc.size(586, 355), cc.p(650.011, 369.5859), nil, nil, nil, nil, false)
	obj:setScale(2, 2)
	...
	setValue(obj, "Button_MoneyTransfer", 181, cc.size(210, 72), cc.p(271.859, 323.473), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_TransferRecord", 182, cc.size(210, 72), cc.p(454.0475, 323.4733), nil, nil, nil, nil, false)
	obj:setScale(0.5, 0.5)
	...
	setValue(obj, "Button_savings", 183, cc.size(210, 72), cc.p(96.8357, 323.473), nil, nil, nil, nil, false)
	obj:setScale(0.5, 0.5)
	...
	setValue(obj, "Button_close", 206, cc.size(17, 13.9998), cc.p(564.5015, 334.1121), cc.p(0.4667, 0.4704), nil, nil, nil, false)
	...
	setValue(obj, "Image_transferFrame", 207, cc.size(1050, 512), cc.p(644.1613, 344.8619), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_10", 208, cc.size(380, 40), cc.p(765.672, 458.551), nil, nil, nil, nil, false)
	...
	setValue(obj, "TextField_5", 222, cc.size(332.583, 32.9214), cc.p(174.2169, 15.2758), nil, nil, nil, nil, false)
	obj:setString([[]])
	...
	setValue(obj, "Image_10_0", 209, cc.size(380, 40), cc.p(770.9491, 400.7645), nil, nil, nil, nil, false)
	obj:loadTexture("baoxiangui/xianshikuang.png", 0)
	...
	setValue(obj, "TextField_6", 223, cc.size(384.2678, 36.1517), cc.p(196.5386, 14.4181), nil, nil, nil, nil, false)
	obj:setString([[]])
	...
	setValue(obj, "Image_12", 210, cc.size(351, 40), cc.p(616.7193, 312.981), nil, nil, nil, nil, false)
	...
	setValue(obj, "TextField_7", 224, cc.size(364.8867, 42.6123), cc.p(188.1777, 18.658), nil, nil, nil, nil, false)
	obj:setString([[]])
	obj:setPlaceHolder([[]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_12_0", 211, cc.size(351, 40), cc.p(616.4934, 251.9661), nil, nil, nil, nil, false)
	obj:loadTexture("denglu/dl_shuruk.png", 0)
	...
	setValue(obj, "TextField_7_0", 225, cc.size(327.9883, 42.6123), cc.p(164.3924, 20.5452), nil, nil, nil, nil, false)
	obj:setString([[]])
	obj:setPlaceHolder([[]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_12_1", 212, cc.size(351, 40), cc.p(617.941, 188.1497), nil, nil, nil, nil, false)
	obj:loadTexture("denglu/dl_shuruk.png", 0)
	...
	setValue(obj, "TextField_7_0_0", 226, cc.size(327.9883, 42.6123), cc.p(162.9442, 19.3307), nil, nil, nil, nil, false)
	obj:setString([[]])
	obj:setPlaceHolder([[]])
	obj:setFontSize(20)
	...
	setValue(obj, "Button_0.1Bi", 213, cc.size(129, 40), cc.p(912.3156, 130.6423), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_50mil", 214, cc.size(129, 40), cc.p(741.1075, 130.6423), nil, nil, nil, nil, false)
	obj:setScale(1.0504, 1.1428)
	...
	setValue(obj, "Button_10,mil", 215, cc.size(129, 40), cc.p(560.264, 130.6423), nil, nil, nil, nil, false)
	obj:setScale(1.0504, 1.1428)
	...
	setValue(obj, "Button_5mil", 216, cc.size(129, 40), cc.p(383.8426, 130.6423), nil, nil, nil, nil, false)
	obj:setScale(1.0504, 1.1428)
	...
	setValue(obj, "Button_1mil", 217, cc.size(129, 40), cc.p(211.1703, 130.4587), nil, nil, nil, nil, false)
	obj:setScale(1.0504, 1.1428)
	...
	setValue(obj, "Button_17", 218, cc.size(154, 44), cc.p(572.924, 56.0595), cc.p(0.6232, 0.3819), nil, nil, nil, false)
	...
	setValue(obj, "CheckBox_6", 219, cc.size(24, 24), cc.p(912.8653, 308.1761), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Image_21", 220, cc.size(81.3614, 62.8694), cc.p(69.4673, 397.5399), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_20", 221, cc.size(81, 84), cc.p(127.7121, 427.5146), nil, nil, nil, nil, false)
	obj:setScale(1.0322, 1.0982)
