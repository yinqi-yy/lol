...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 272, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_1 = obj
	setValue(obj, "Image_1", 273, cc.size(1334, 750), cc.p(671.381, 375.0895), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_2", 274, cc.size(127, 106), cc.p(671.3718, 658.729), cc.p(0.5203, 0.4207), nil, nil, nil, false)
	...
	setValue(obj, "Image_3", 275, cc.size(124, 80), cc.p(512.6336, 663.717), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_4", 276, cc.size(124, 80), cc.p(357.4137, 664.0129), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_5", 277, cc.size(93, 26), cc.p(201.3271, 661.6219), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_7", 278, cc.size(133, 80), cc.p(199.1375, 468.9519), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_8", 279, cc.size(126, 80), cc.p(201.272, 371.2233), cc.p(0.5256, 0.4826), nil, nil, nil, false)
	...
	setValue(obj, "Image_9", 280, cc.size(126, 80), cc.p(518.3776, 83.8303), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_6", 281, cc.size(124.7049, 80), cc.p(193.0913, 564.2672), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_11", 282, cc.size(131, 80), cc.p(199.615, 276.1176), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_12", 283, cc.size(130, 80), cc.p(198.6949, 177.6385), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_13", 284, cc.size(133, 80), cc.p(668.2703, 81.6706), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_14", 285, cc.size(124, 80), cc.p(355.4428, 81.8798), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_15", 286, cc.size(126, 80), cc.p(1142.6708, 269.5233), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_16", 287, cc.size(93, 26), cc.p(197.0297, 86.9261), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_17", 288, cc.size(124, 80), cc.p(1140.0402, 560.9535), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml2_an.png", 0)
	...
	setValue(obj, "Image_18", 289, cc.size(131, 80), cc.p(983.0468, 82.0891), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_19", 290, cc.size(129.1848, 80), cc.p(1139.0405, 175.2021), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml4_an.png", 0)
	...
	setValue(obj, "Image_20", 291, cc.size(93, 26), cc.p(1145.0854, 77.252), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_21", 292, cc.size(131, 80), cc.p(1135.4105, 371.1009), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7_an.png", 0)
	...
	setValue(obj, "Image_22", 293, cc.size(93, 26), cc.p(1142.6672, 666.1584), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_23", 294, cc.size(126, 80), cc.p(824.6349, 664.9493), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_24", 295, cc.size(133, 80), cc.p(982.2574, 662.5311), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_25", 296, cc.size(124, 80), cc.p(1138.412, 464.0044), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_26", 297, cc.size(124, 80), cc.p(825.6338, 80.6707), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "AtlasLabel_1", 298, cc.size(70, 18), cc.p(703.541, 409.5837), nil, nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_2", 299, cc.size(84, 18), cc.p(467.9618, 165.3318), cc.p(0.5051, 0.4053), nil, nil, nil, nil)
	obj:setRotationSkewX(1.0632)
	obj:setRotationSkewY(1.0632)
	obj:setProperty([[000000]], "Default/TextAtlas.png", 14, 18, [[.]])
	bind(obj).setMargin(425.5356, 573.9632, 824.4645, 158.0368)

	obj = ccui.TextAtlas:create()
	roots.Image_1_1:addChild(obj)
	roots.root.AtlasLabel_3 = obj
	setValue(obj, "AtlasLabel_3", 300, cc.size(84, 18), cc.p(741.6102, 167.8889), nil, nil, nil, nil, nil)
	obj:setProperty([[000000]], "Default/TextAtlas.png", 14, 18, [[.]])
	...
	setValue(obj, "AtlasLabel_4", 301, cc.size(14, 18), cc.p(971.7622, 167.4369), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Button_1", 302, cc.size(17, 14), cc.p(1284.8573, 724.1099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Panel_1", 305, cc.size(162.8942, 127.475), cc.p(312.3876, 208.9959), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Panel_1_1", 307, cc.size(171.9986, 130.8891), cc.p(493.903, 204.4732), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	...
	setValue(obj, "Panel_1_0", 306, cc.size(162.8942, 127.475), cc.p(322.3877, 198.9959), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	...
	setValue(obj, "Image_30", 311, cc.size(150, 100), cc.p(73.0511, 68.5005), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7.png", 0)
	...
	setValue(obj, "Panel_1_2", 308, cc.size(167.6679, 141.0964), cc.p(761.9683, 263.6711), cc.p(0.4768, 0.446), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	...
	setValue(obj, "Panel_1_2_0", 310, cc.size(167.6679, 141.0964), cc.p(942.6775, 261.6382), cc.p(0.4768, 0.446), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
