...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 416, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_10 = obj
	setValue(obj, "Image_10", 417, cc.size(1333, 197), cc.p(669.2845, 97.635), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Start", 418, cc.size(154, 132), cc.p(1211.7434, 113.506), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_AutoPlay", 419, cc.size(183, 55), cc.p(925.4624, 65.7392), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Allin", 420, cc.size(183, 55), cc.p(605.1821, 65.739), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "Image_bettingcredits", 421, cc.size(193, 50), cc.p(211.2194, 68.1561), nil, nil, nil, nil, false)
	...
	setValue(obj, "AtlasLabel_betperline", 422, cc.size(42, 18), cc.p(108.826, 26.7275), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Down_0", 423, cc.size(33, 31), cc.p(247.698, 23.5369), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	...
	setValue(obj, "Button_Up_0", 424, cc.size(33, 31), cc.p(-47.3374, 23.9195), nil, nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	...
	setValue(obj, "Image_TotalBeting", 425, cc.size(230, 40), cc.p(621.9366, 140.3822), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "AtlasLabel_betamount", 426, cc.size(56, 18), cc.p(136.8222, 14.3275), cc.p(0.5527, 0.3322), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Image_ToralWinning", 427, cc.size(230, 40), cc.p(936.2433, 141.9973), cc.p(0.5351, 0.5351), nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "AtlasLabel_winamount", 428, cc.size(14, 18), cc.p(118.1948, 19.3176), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Image_TotalLinesBet", 429, cc.size(193, 50), cc.p(212.0682, 139.294), nil, nil, nil, nil, false)
	...
	setValue(obj, "AtlasLabel_totallinesbeton", 430, cc.size(14, 18), cc.p(106.9727, 25.2817), cc.p(0.5179, 0.6692), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Up", 431, cc.size(33, 31), cc.p(-48.0443, 28.7967), nil, nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/shang_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	...
	setValue(obj, "Button_Down", 432, cc.size(33, 31), cc.p(247.4864, 27.4133), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/xia_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
