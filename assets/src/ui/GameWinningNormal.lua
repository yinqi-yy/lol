...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 566, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_upperbar = obj
	setValue(obj, "Image_upperbar", 583, cc.size(1334, 46), cc.p(667.2247, 744.3318), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_bank", 584, cc.size(57, 74), cc.p(190.4979, -21.6531), cc.p(0.4881, 0.6434), nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 585, cc.size(122, 40), cc.p(83.1921, -29.4099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 586, cc.size(41, 43), cc.p(1201.5984, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 587, cc.size(41, 43), cc.p(1265.7904, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 588, cc.size(41, 43), cc.p(1131.9803, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 589, cc.size(41, 43), cc.p(1066.943, 23.5887), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 590, cc.size(41, 43), cc.p(1000.1219, 26.5582), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 591, cc.size(33, 30.4771), cc.p(62.265, 28.97), cc.p(0.3486, 0.7411), nil, nil, nil, false)
	obj:setScale(1.0028, 1)
	...
	setValue(obj, "Text_MoneyCarried", 592, cc.size(98, 26), cc.p(147.6945, 23.9471), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_ID", 593, cc.size(62, 26), cc.p(367.9602, 24.6771), nil, nil, nil, nil, nil)
	obj:setString([[88888]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_MessageBg", 594, cc.size(351, 40), cc.p(694.0069, -23.8304), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Text_IngameMessage", 595, cc.size(507, 26), cc.p(623.9014, -25.0923), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_IngameMessage", 596, cc.size(24, 21), cc.p(275.3341, -27.9559), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_GameRoomBg", 597, cc.size(1334, 671), cc.p(668.041, 335.1458), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_roomNo.", 598, cc.size(62, 28), cc.p(1137.6458, 693.1521), nil, nil, nil, nil, false)
	...
	setValue(obj, "Text_Number", 599, cc.size(49, 34), cc.p(1194.2546, 695.3958), cc.p(0.5145, 0.4653), cc.c4b(214, 158, 0, 255), nil, nil, nil)
	obj:setString([[005]])
	obj:setFontSize(26)
	...
	setValue(obj, "Image_CardFrame", 600, cc.size(928, 399), cc.p(668.4911, 415.6999), nil, nil, nil, nil, false)
	...
	setValue(obj, "Sprite_card1", 601, cc.size(201, 132), cc.p(91.0453, 331.6186), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card2", 602, cc.size(201, 132), cc.p(90.6441, 189.726), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card3", 603, cc.size(201, 132), cc.p(91.8049, 56.5154), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card4", 604, cc.size(201, 132), cc.p(281.6025, 331.6186), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card5", 605, cc.size(201, 132), cc.p(281.3912, 190.4442), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card6", 606, cc.size(201, 132), cc.p(281.3891, 56.4074), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card7", 607, cc.size(201, 132), cc.p(470.8074, 330.7037), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card8", 608, cc.size(201, 132), cc.p(470.8014, 190.0493), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card9", 609, cc.size(201, 132), cc.p(470.8012, 55.2276), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card10", 610, cc.size(201, 132), cc.p(662.7795, 330.3331), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card11", 611, cc.size(201, 132), cc.p(855.3063, 329.7948), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card12", 612, cc.size(201, 132), cc.p(662.7872, 192.0216), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card13", 613, cc.size(201, 132), cc.p(662.7795, 55.6194), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card14", 614, cc.size(201, 132), cc.p(854.8752, 191.2307), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card15", 615, cc.size(201, 132), cc.p(854.8729, 55.3952), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Image_Line2", 616, cc.size(976, 3), cc.p(475.7208, 336.1165), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_Line3", 617, cc.size(976, 3), cc.p(475.7208, 69.7628), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line1", 618, cc.size(976, 3), cc.p(480.0378, 197.2586), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line6", 619, cc.size(972, 105), cc.p(473.7202, 257.8553), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_IngameLowerBar", 567, cc.size(1333, 197), cc.p(669.0146, 99.9157), nil, nil, 218, nil, false)
	obj:loadTexture("youxi_xia1_03.png", 0)
	bind(obj).setMargin(2.5146, 472.5843, -1.5146, 1.4157)
	roots.Image_IngameLowerBar_2 = obj

	obj = ccui.ImageView:create()
	roots.Image_IngameLowerBar_2:addChild(obj)
	roots.root.Image_TotalLinesBet = obj
	setValue(obj, "Image_TotalLinesBet", 568, cc.size(193, 50), cc.p(217.7004, 129.9063), nil, nil, nil, nil, false)
	obj:loadTexture("youxi/yaxian.png", 0)
	bind(obj).setMargin(121.2004, 42.0937, 1018.7996, 104.9063)
	roots.Image_TotalLinesBet_3 = obj

	obj = ccui.TextAtlas:create()
	roots.Image_TotalLinesBet_3:addChild(obj)
	roots.root.AtlasLabel_totallinesbeton = obj
	setValue(obj, "AtlasLabel_totallinesbeton", 569, cc.size(14, 18), cc.p(106.9727, 25.2817), cc.p(0.5179, 0.6692), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Up", 570, cc.size(33, 31), cc.p(-48.0443, 28.7967), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Down", 571, cc.size(33, 31), cc.p(247.4864, 27.4133), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	...
	setValue(obj, "Image_TotalBeting", 574, cc.size(230, 40), cc.p(627.5697, 130.9944), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	obj:loadTexture("youxi/zongyafen.png", 0)
	bind(obj).setMargin(512.5697, 46.0056, 590.4303, 110.9944)
	roots.Image_TotalBeting_3 = obj

	obj = ccui.TextAtlas:create()
	roots.Image_TotalBeting_3:addChild(obj)
	roots.root.AtlasLabel_betamount = obj
	setValue(obj, "AtlasLabel_betamount", 575, cc.size(56, 18), cc.p(136.8222, 14.3275), cc.p(0.5527, 0.3322), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Image_bettingcredits", 576, cc.size(193, 50), cc.p(216.8519, 58.7683), nil, nil, nil, nil, false)
	obj:loadTexture("youxi/yaxian.png", 0)
	bind(obj).setMargin(120.3519, 113.2317, 1019.6481, 33.7683)
	roots.Image_bettingcredits_3 = obj

	obj = ccui.TextAtlas:create()
	roots.Image_bettingcredits_3:addChild(obj)
	roots.root.AtlasLabel_betperline = obj
	setValue(obj, "AtlasLabel_betperline", 577, cc.size(42, 18), cc.p(108.826, 26.7275), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Down_0", 578, cc.size(33, 31), cc.p(247.698, 23.5369), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/xia_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	...
	setValue(obj, "Button_Up_0", 579, cc.size(33, 31), cc.p(-47.3374, 23.9195), nil, nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/shang_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	...
	setValue(obj, "Button_Allin", 580, cc.size(183, 55), cc.p(610.8147, 56.3509), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "Button_AutoPlay", 581, cc.size(183, 55), cc.p(931.0951, 56.351), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "Button_Start", 582, cc.size(154, 132), cc.p(1217.3752, 104.118), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_ToralWinning", 572, cc.size(230, 40), cc.p(941.8759, 132.6091), cc.p(0.5351, 0.5351), nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	obj:loadTexture("youxi/defen.png", 0)
	bind(obj).setMargin(818.8029, 45.7949, 284.197, 111.2051)
	roots.Image_ToralWinning_3 = obj

	obj = ccui.TextAtlas:create()
	roots.Image_ToralWinning_3:addChild(obj)
	roots.root.AtlasLabel_winamount = obj
	setValue(obj, "AtlasLabel_winamount", 573, cc.size(56, 18), cc.p(118.1948, 19.3176), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
	obj:setProperty([[2000]], "Default/TextAtlas.png", 14, 18, [[.]])
	bind(obj).setMargin(90.1948, 11.6824, 83.8052, 10.3176)

	obj = ccui.Layout:create()
	roots.Layer_0:addChild(obj)
	roots.root.Panel_1 = obj
	setValue(obj, "Panel_1", 620, cc.size(1322.4741, 762.7664), cc.p(5.5646, 13.8819), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 133, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	bind(obj).setMargin(5.5646, -26.6483, 5.9613, 13.8819)
	roots.Panel_1_1 = obj

	obj = ccui.TextAtlas:create()
	roots.Panel_1_1:addChild(obj)
	roots.root.AtlasLabel_5 = obj
	setValue(obj, "AtlasLabel_5", 622, cc.size(104, 30), cc.p(663.7794, 398.1729), nil, nil, nil, nil, nil)
	obj:setScale(1.8, 1.8)
	obj:setProperty([[2000]], "xiaomalishuzi_03.png", 26, 30, [[0]])
	bind(obj).setMargin(611.7794, 349.5935, 606.6947, 383.1729)
	roots.AtlasLabel_5_2 = obj

	obj = cc.Sprite:create()
	roots.AtlasLabel_5_2:addChild(obj)
	roots.root.Sprite_16 = obj
	setValue(obj, "Sprite_16", 623, cc.size(60, 54), cc.p(171.9813, 21.5918), nil, nil, nil, nil, nil)
	obj:setTexture("1.png")
	bind(obj).setMargin(141.9813, -18.5918, -97.9813, -5.4082)

	obj = cc.Sprite:create()
	roots.AtlasLabel_5_2:addChild(obj)
	roots.root.Sprite_17 = obj
	setValue(obj, "Sprite_17", 624, cc.size(127, 99), cc.p(161.4489, -13.9927), nil, nil, nil, nil, nil)
	obj:setScale(0.8, 0.8)
	obj:setTexture("sch.png")
	bind(obj).setMargin(97.9489, -5.5073, -120.9489, -63.4927)

	obj = ccui.ImageView:create()
	roots.AtlasLabel_5_2:addChild(obj)
	roots.root.Image_17 = obj
	setValue(obj, "Image_17", 621, cc.size(395, 102), cc.p(78.3422, 94.22), nil, nil, nil, nil, false)
	obj:loadTexture("wining.png", 0)
	bind(obj).setMargin(-119.1578, -115.22, -171.8422, 43.22)

	obj = cc.Sprite:create()
	roots.Panel_1_1:addChild(obj)
	roots.root.Sprite_18 = obj
	setValue(obj, "Sprite_18", 625, cc.size(60, 54), cc.p(522.7849, 352.3525), nil, nil, nil, nil, nil)
	obj:setTexture("1.png")
	bind(obj).setMargin(492.7849, 383.4139, 769.6892, 325.3525)
	roots.Sprite_18_2 = obj

	obj = cc.Sprite:create()
	roots.Sprite_18_2:addChild(obj)
	roots.root.Sprite_19 = obj
	setValue(obj, "Sprite_19", 626, cc.size(60, 54), cc.p(-7.4504, 61.1523), cc.p(0.5188, 0.5265), nil, nil, nil, nil)
	obj:setScale(2, 2)
	obj:setTexture("1.png")
	bind(obj).setMargin(-38.5784, -32.7213, 38.5784, 32.7213)
