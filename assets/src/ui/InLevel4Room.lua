...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 282, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_LobbyBg = obj
	setValue(obj, "Image_LobbyBg", 283, cc.size(1334, 727), cc.p(667.6188, 343.2351), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_roomInfoBg", 284, cc.size(1334, 502), cc.p(667.0439, 364.7429), nil, nil, nil, nil, false)
	...
	setValue(obj, "Sprite_NumberCount", 285, cc.size(113, 24), cc.p(965.6843, 396.3531), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_RoomFull", 286, cc.size(113, 24), cc.p(56.005, 11.0163), nil, nil, nil, nil, nil)
	...
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Sprite_NumberCount = obj
	setValue(obj, "Sprite_NumberCount", 287, cc.size(113, 24), cc.p(965.7332, 343.3323), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_LessthanHalf", 288, cc.size(29, 24), cc.p(13.9587, 11.3696), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Button_Spot", 289, cc.size(196, 52), cc.p(1209.9893, 221.8681), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_QuickStart", 290, cc.size(196, 52), cc.p(1210.772, 348.4102), nil, nil, nil, nil, false)
	...
	setValue(obj, "Text_room#", 291, cc.size(38, 26), cc.p(115.9141, 405.2881), nil, nil, nil, nil, nil)
	obj:setString([[001]])
	obj:setFontSize(20)
	...
	setValue(obj, "Text_AvgReturn", 292, cc.size(56, 26), cc.p(371.5105, 404.4188), nil, nil, nil, nil, nil)
	obj:setString([[2,567]])
	obj:setFontSize(20)
	...
	setValue(obj, "Text_BiggestWin", 293, cc.size(80, 26), cc.p(725.4262, 406.9139), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[234,567]])
	obj:setFontSize(20)
	bind(obj).setMargin(685.7142, 83.7397, 568.2858, 392.2603)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_room#_0 = obj
	setValue(obj, "Text_room#_0", 294, cc.size(38, 26), cc.p(114.985, 353.9232), nil, nil, nil, nil, nil)
	obj:setString([[002]])
	obj:setFontSize(20)
	...
	setValue(obj, "Text_AvgReturn_0", 295, cc.size(57, 26), cc.p(370.6114, 353.8041), nil, nil, nil, nil, nil)
	obj:setString([[1,234]])
	obj:setFontSize(20)
	bind(obj).setMargin(342.1114, 135.1959, 934.8886, 340.8041)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWin_0 = obj
	setValue(obj, "Text_BiggestWin_0", 296, cc.size(80, 26), cc.p(725.9041, 355.4609), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[678,902]])
	obj:setFontSize(20)
	bind(obj).setMargin(686.1921, 135.1927, 567.8079, 340.8073)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWininLevel1 = obj
	setValue(obj, "Text_BiggestWininLevel1", 297, cc.size(152, 26), cc.p(479.2555, 51.8863), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_TotalNumofPpl", 298, cc.size(39, 26), cc.p(863.481, 55.7036), nil, nil, nil, nil, nil)
	obj:setString([[234]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_Level2", 299, cc.size(153, 38), cc.p(1219.6611, 521.5032), nil, nil, nil, nil, false)
	obj:loadTexture("fangjian/fm2.png", 0)
	bind(obj).setMargin(1143.1611, -38.5032, 37.8389, 502.5032)

	obj = ccui.Layout:create()
	roots.Image_LobbyBg_1:addChild(obj)
	roots.root.Panel_lowerbar = obj
	setValue(obj, "Panel_lowerbar", 300, cc.size(1319.6129, 100.8273), cc.p(666.0419, 51.2175), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
	...
	setValue(obj, "Button_daily", 301, cc.size(77, 73), cc.p(1194.4596, 53.895), cc.p(0.5013, 0.5246), nil, nil, nil, false)
	...
	setValue(obj, "Button_Competition", 302, cc.size(75, 82), cc.p(200.5307, 56.1186), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_SystemNotice", 303, cc.size(76, 79), cc.p(309.9258, 56.1193), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_VIP", 304, cc.size(75, 76), cc.p(54.6709, 53.4179), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_wealth", 305, cc.size(84, 77), cc.p(1043.2777, 52.593), cc.p(0.5322, 0.4804), nil, nil, nil, false)
	...
	setValue(obj, "Image_upperbar", 306, cc.size(1334, 46), cc.p(667.2247, 744.3318), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_bank", 307, cc.size(57, 74), cc.p(190.3174, -32.0147), cc.p(0.4185, 0.5675), nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 308, cc.size(122, 40), cc.p(83.1921, -29.4099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 309, cc.size(41, 43), cc.p(1201.5984, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 310, cc.size(41, 43), cc.p(1265.7904, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 311, cc.size(41, 43), cc.p(1131.9803, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 312, cc.size(41, 43), cc.p(1066.943, 23.5887), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 313, cc.size(41, 43), cc.p(1000.1219, 26.5582), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 314, cc.size(33, 30.4771), cc.p(62.265, 28.97), cc.p(0.3486, 0.7411), nil, nil, nil, false)
	obj:setScale(1.0028, 1)
	...
	setValue(obj, "Text_MoneyCarried", 315, cc.size(98, 26), cc.p(147.6945, 23.9471), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_ID", 316, cc.size(62, 26), cc.p(367.9602, 24.6771), nil, nil, nil, nil, nil)
	obj:setString([[88888]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_MessageBg", 317, cc.size(351, 40), cc.p(682.7983, -52.9748), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Text_IngameMessage", 318, cc.size(507, 26), cc.p(627.7129, -52.5462), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_IngameMessage", 319, cc.size(24, 21), cc.p(276.0958, -54.6474), nil, nil, nil, nil, false)
