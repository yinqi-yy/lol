...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 688, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_1 = obj
	setValue(obj, "Image_1", 689, cc.size(1334, 750), cc.p(671.381, 375.0895), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_2", 690, cc.size(127, 106), cc.p(671.3718, 658.729), cc.p(0.5203, 0.4207), nil, nil, nil, false)
	...
	setValue(obj, "Image_3", 691, cc.size(124, 80), cc.p(512.6336, 663.717), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_4", 692, cc.size(124, 80), cc.p(357.4137, 664.0129), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_5", 693, cc.size(93, 26), cc.p(201.3271, 661.6219), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9.png", 0)
	bind(obj).setMargin(154.8271, 75.3781, 1086.1729, 648.6219)

	obj = ccui.ImageView:create()
	roots.Image_1_1:addChild(obj)
	roots.root.Image_7 = obj
	setValue(obj, "Image_7", 694, cc.size(133, 80), cc.p(199.1375, 468.9519), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_8", 695, cc.size(126, 80), cc.p(201.272, 371.2233), cc.p(0.5256, 0.4826), nil, nil, nil, false)
	...
	setValue(obj, "Image_9", 696, cc.size(126, 80), cc.p(518.3776, 83.8303), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_6", 697, cc.size(124.7049, 80), cc.p(193.0913, 564.2672), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_11", 698, cc.size(131, 80), cc.p(199.615, 276.1176), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_12", 699, cc.size(130, 80), cc.p(198.6949, 177.6385), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_13", 700, cc.size(133, 80), cc.p(668.2703, 81.6706), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_14", 701, cc.size(124, 80), cc.p(355.4428, 81.8798), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_15", 702, cc.size(126, 80), cc.p(1142.6708, 269.5233), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_16", 703, cc.size(93, 26), cc.p(197.0297, 86.9261), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_17", 704, cc.size(124, 80), cc.p(1140.0402, 560.9535), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml2_an.png", 0)
	...
	setValue(obj, "Image_18", 705, cc.size(131, 80), cc.p(983.0468, 82.0891), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7_an.png", 0)
	...
	setValue(obj, "Image_19", 706, cc.size(129.1848, 80), cc.p(1139.0405, 175.2021), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml4_an.png", 0)
	...
	setValue(obj, "Image_20", 707, cc.size(93, 26), cc.p(1145.0854, 77.252), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_21", 708, cc.size(131, 80), cc.p(1135.4105, 371.1009), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7_an.png", 0)
	...
	setValue(obj, "Image_22", 709, cc.size(93, 26), cc.p(1142.6672, 666.1584), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_23", 710, cc.size(126, 80), cc.p(824.6349, 664.9493), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_24", 711, cc.size(133, 80), cc.p(982.2574, 662.5311), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_25", 712, cc.size(124, 80), cc.p(1138.412, 464.0044), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_26", 713, cc.size(124, 80), cc.p(825.6338, 80.6707), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "AtlasLabel_1", 714, cc.size(70, 18), cc.p(703.541, 409.5837), nil, nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_2", 715, cc.size(84, 18), cc.p(467.9618, 165.3318), cc.p(0.5051, 0.4053), nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_3", 716, cc.size(84, 18), cc.p(741.6102, 167.8889), nil, nil, nil, nil, nil)
	obj:setProperty([[000000]], "Default/TextAtlas.png", 14, 18, [[.]])
	...
	setValue(obj, "AtlasLabel_4", 717, cc.size(70, 18), cc.p(971.7622, 167.4369), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Button_1", 718, cc.size(17, 14), cc.p(1284.8573, 724.1099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Panel_1", 719, cc.size(1332.2316, 744.311), cc.p(3.8612, 8.1994), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 132, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	bind(obj).setMargin(3.8612, -2.5104, -2.0928, 8.1994)
	roots.Panel_1_1 = obj

	obj = ccui.Text:create()
	roots.Panel_1_1:addChild(obj)
	roots.root.Text_1 = obj
	setValue(obj, "Text_1", 721, cc.size(522, 126), cc.p(657.3685, 365.0276), nil, cc.c4b(191, 191, 191, 255), nil, nil, nil)
	obj:setString([[            哎呀
今天忘记穿幸运内裤了...]])
	obj:setFontSize(48)
	obj:enableOutline(cc.c4b(127, 127, 127, 255), 0)
	obj:setTextColor(cc.c4b(191, 191, 191, 255))
	bind(obj).setMargin(396.3685, 316.2834, 413.863, 302.0276)

	obj = ccui.Text:create()
	roots.Panel_1_1:addChild(obj)
	roots.root.Text_2 = obj
	setValue(obj, "Text_2", 722, cc.size(277, 26), cc.p(662.2151, 201.896), nil, cc.c4b(191, 191, 191, 255), nil, nil, nil)
	obj:setString([[点 击 屏 幕 任意 处 继 续 游 戏]])
	obj:setFontSize(20)
	obj:setTextColor(cc.c4b(191, 191, 191, 255))
	bind(obj).setMargin(523.7151, 529.415, 531.5165, 188.896)
