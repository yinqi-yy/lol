...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 592, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_upperbar = obj
	setValue(obj, "Image_upperbar", 593, cc.size(1334, 46), cc.p(667.2247, 744.3318), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_bank", 594, cc.size(57, 74), cc.p(190.3174, -32.0147), cc.p(0.4185, 0.5675), nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 595, cc.size(122, 40), cc.p(83.1921, -29.4099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 596, cc.size(41, 43), cc.p(1201.5984, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 597, cc.size(41, 43), cc.p(1265.7904, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 598, cc.size(41, 43), cc.p(1131.9803, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 599, cc.size(41, 43), cc.p(1066.943, 23.5887), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 600, cc.size(41, 43), cc.p(1000.1219, 26.5582), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 601, cc.size(33, 30.4771), cc.p(62.265, 28.97), cc.p(0.3486, 0.7411), nil, nil, nil, false)
	obj:setScale(1.0028, 1)
	...
	setValue(obj, "Text_MoneyCarried", 602, cc.size(98, 26), cc.p(147.6945, 23.9471), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_ID", 603, cc.size(62, 26), cc.p(367.9602, 24.6771), nil, nil, nil, nil, nil)
	obj:setString([[88888]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_MessageBg", 604, cc.size(351, 40), cc.p(682.7983, -52.9748), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Text_IngameMessage", 605, cc.size(507, 26), cc.p(627.7129, -52.5462), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_IngameMessage", 606, cc.size(24, 21), cc.p(276.0958, -54.6474), nil, nil, nil, nil, false)
	...
	setValue(obj, "Panel_lowerbar", 607, cc.size(1319.6129, 100.8273), cc.p(666.0419, 51.2175), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
	...
	setValue(obj, "Button_daily", 608, cc.size(77, 73), cc.p(1194.4596, 53.895), cc.p(0.5013, 0.5246), nil, nil, nil, false)
	...
	setValue(obj, "Button_Competition", 609, cc.size(75, 82), cc.p(200.5307, 56.1186), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_SystemNotice", 610, cc.size(76, 79), cc.p(309.9258, 56.1193), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_VIP", 611, cc.size(75, 76), cc.p(54.6709, 53.4179), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_wealth", 612, cc.size(84, 77), cc.p(1043.2777, 52.593), cc.p(0.5322, 0.4804), nil, nil, nil, false)
