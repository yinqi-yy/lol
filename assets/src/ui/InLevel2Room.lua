...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 86, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_LobbyBg = obj
	setValue(obj, "Image_LobbyBg", 189, cc.size(1334, 727), cc.p(667.6188, 343.2351), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_roomInfoBg", 190, cc.size(1334, 502), cc.p(667.0439, 366.0934), nil, nil, nil, nil, false)
	obj:loadTexture("fangjian/fangjian_bj.png", 0)
	bind(obj).setMargin(0.0439, 109.9066, -0.0439, 115.0934)
	roots.Image_roomInfoBg_2 = obj

	obj = cc.Sprite:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Sprite_NumberCount = obj
	setValue(obj, "Sprite_NumberCount", 191, cc.size(113, 24), cc.p(966.9435, 406.4498), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_RoomFull", 192, cc.size(113, 24), cc.p(56.005, 11.0163), nil, nil, nil, nil, nil)
	...
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Sprite_NumberCount = obj
	setValue(obj, "Sprite_NumberCount", 193, cc.size(113, 24), cc.p(966.9927, 353.4302), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_LessthanHalf", 194, cc.size(29, 24), cc.p(13.9587, 11.3696), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Button_Spot", 195, cc.size(196, 52), cc.p(1209.9851, 267.3111), nil, nil, nil, nil, false)
	...
	bind(obj).setMargin(1111.9851, 208.6889, 26.0149, 241.3111)

	obj = ccui.Button:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	obj:setCapInsets(cc.rect(15, 11, 166, 30))
	roots.root.Button_QuickStart = obj
	setValue(obj, "Button_QuickStart", 196, cc.size(196, 52), cc.p(1210.77, 393.8519), nil, nil, nil, nil, false)
	obj:loadTextureNormal("fangjian/kuaisukaishi.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	obj:setTitleFontSize(14)
	bind(obj).setMargin(1112.77, 82.1481, 25.23, 367.8519)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_room# = obj
	setValue(obj, "Text_room#", 197, cc.size(38, 26), cc.p(117.1761, 415.3848), nil, nil, nil, nil, nil)
	obj:setString([[001]])
	obj:setFontSize(20)
	bind(obj).setMargin(98.1761, 73.6152, 1197.8239, 402.3848)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_AvgReturn = obj
	setValue(obj, "Text_AvgReturn", 198, cc.size(56, 26), cc.p(372.7715, 414.5154), nil, nil, nil, nil, nil)
	obj:setString([[2,567]])
	obj:setFontSize(20)
	bind(obj).setMargin(344.7715, 74.4846, 933.2285, 401.5154)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWin = obj
	setValue(obj, "Text_BiggestWin", 199, cc.size(80, 26), cc.p(726.6852, 417.0107), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[234,567]])
	obj:setFontSize(20)
	bind(obj).setMargin(686.9732, 73.6429, 567.0268, 402.3571)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_room#_0 = obj
	setValue(obj, "Text_room#_0", 200, cc.size(38, 26), cc.p(116.2468, 357.0207), nil, nil, nil, nil, nil)
	obj:setString([[002]])
	obj:setFontSize(20)
	bind(obj).setMargin(97.2468, 131.9793, 1198.7532, 344.0207)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_AvgReturn_0 = obj
	setValue(obj, "Text_AvgReturn_0", 201, cc.size(57, 26), cc.p(371.8727, 356.9017), nil, nil, nil, nil, nil)
	obj:setString([[1,234]])
	obj:setFontSize(20)
	bind(obj).setMargin(343.3727, 132.0983, 933.6273, 343.9017)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWin_0 = obj
	setValue(obj, "Text_BiggestWin_0", 202, cc.size(80, 26), cc.p(727.1635, 357.558), cc.p(0.4964, 0.5636), nil, nil, nil, nil)
	obj:setString([[678,902]])
	obj:setFontSize(20)
	bind(obj).setMargin(687.4515, 133.0956, 566.5485, 342.9044)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_BiggestWininLevel1 = obj
	setValue(obj, "Text_BiggestWininLevel1", 203, cc.size(152, 26), cc.p(474.2052, 64.5095), nil, nil, nil, nil, nil)
	obj:setString([[12,345,678,900]])
	obj:setFontSize(20)
	bind(obj).setMargin(398.2052, 424.4905, 783.7948, 51.5095)

	obj = ccui.Text:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Text_TotalNumofPpl = obj
	setValue(obj, "Text_TotalNumofPpl", 204, cc.size(39, 26), cc.p(856.6985, 64.1078), cc.p(0.4423, 0.5652), nil, nil, nil, nil)
	obj:setString([[234]])
	obj:setFontSize(20)
	bind(obj).setMargin(839.448, 426.5864, 455.552, 49.4136)

	obj = ccui.ImageView:create()
	roots.Image_roomInfoBg_2:addChild(obj)
	roots.root.Image_Level2 = obj
	setValue(obj, "Image_Level2", 205, cc.size(153, 38), cc.p(1219.6611, 521.5032), nil, nil, nil, nil, false)
	...
	setValue(obj, "Panel_lowerbar", 169, cc.size(1319.6129, 100.8273), cc.p(668.5653, 13.3469), cc.p(0.4964, 0.4008), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 0, cc.c4b(150, 200, 255, 255), nil, nil, nil)
	bind(obj).setMargin(13.5095, 676.2374, 0.8777, -27.0647)
	...
	setValue(obj, "Button_daily", 170, cc.size(77, 73), cc.p(1194.4596, 53.895), cc.p(0.5013, 0.5246), nil, nil, nil, false)
	...
	setValue(obj, "Button_Competition", 171, cc.size(75, 82), cc.p(200.5307, 56.1186), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_SystemNotice", 172, cc.size(76, 79), cc.p(309.9258, 56.1193), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_VIP", 173, cc.size(75, 76), cc.p(54.6709, 53.4179), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_wealth", 174, cc.size(84, 77), cc.p(1043.2777, 52.593), cc.p(0.5322, 0.4804), nil, nil, nil, false)
	...
	setValue(obj, "Image_upperbar", 175, cc.size(1334, 46), cc.p(667.2248, 725.3325), nil, nil, nil, nil, false)
	obj:loadTexture("dating/shang_bj.png", 0)
	bind(obj).setMargin(0.2248, 1.6675, -0.2249, 702.3325)
	roots.Image_upperbar_1 = obj

	obj = ccui.ImageView:create()
	roots.Image_upperbar_1:addChild(obj)
	roots.root.Image_bank = obj
	setValue(obj, "Image_bank", 176, cc.size(57, 74), cc.p(190.3174, -32.0147), cc.p(0.4185, 0.5675), nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 177, cc.size(122, 40), cc.p(83.1921, -29.4099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 178, cc.size(41, 43), cc.p(1201.5984, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 179, cc.size(41, 43), cc.p(1265.7904, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 180, cc.size(41, 43), cc.p(1131.9803, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 181, cc.size(41, 43), cc.p(1066.943, 23.5887), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 182, cc.size(41, 43), cc.p(1000.1219, 26.5582), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 183, cc.size(33, 30.4771), cc.p(62.265, 28.97), cc.p(0.3486, 0.7411), nil, nil, nil, false)
	obj:setScale(1.0028, 1)
	...
	setValue(obj, "Text_MoneyCarried", 184, cc.size(98, 26), cc.p(147.6945, 23.9471), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_ID", 185, cc.size(62, 26), cc.p(367.9602, 24.6771), nil, nil, nil, nil, nil)
	obj:setString([[88888]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_4", 186, cc.size(351, 40), cc.p(682.7983, -52.9748), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Text_IngameMessage", 188, cc.size(507, 26), cc.p(627.7129, -52.5462), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_IngameMessage", 187, cc.size(24, 21), cc.p(276.0958, -54.6474), nil, nil, nil, nil, false)
