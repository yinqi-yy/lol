...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 321, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_GameRoomBg = obj
	setValue(obj, "Image_GameRoomBg", 322, cc.size(1334, 671), cc.p(668.041, 335.1458), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_CardFrame", 357, cc.size(928, 399), cc.p(668.4911, 415.6999), nil, nil, nil, nil, false)
	...
	setValue(obj, "Sprite_card1", 358, cc.size(201, 132), cc.p(91.0453, 331.6186), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card2", 359, cc.size(201, 132), cc.p(90.6441, 189.726), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card3", 360, cc.size(201, 132), cc.p(91.8049, 56.5154), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card4", 361, cc.size(201, 132), cc.p(281.6025, 331.6186), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Sprite_card5", 362, cc.size(201, 132), cc.p(281.3912, 190.4442), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card6", 363, cc.size(201, 132), cc.p(281.3891, 56.4074), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card7", 364, cc.size(201, 132), cc.p(470.8074, 330.7037), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card8", 365, cc.size(201, 132), cc.p(470.8014, 190.0493), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card9", 366, cc.size(201, 132), cc.p(470.8012, 55.2276), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card10", 367, cc.size(201, 132), cc.p(662.7795, 330.3331), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card11", 368, cc.size(201, 132), cc.p(855.3063, 329.7948), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card12", 369, cc.size(201, 132), cc.p(662.7872, 192.0216), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card13", 370, cc.size(201, 132), cc.p(662.7795, 55.6194), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card14", 371, cc.size(201, 132), cc.p(854.8752, 191.2307), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Sprite_card15", 372, cc.size(201, 132), cc.p(854.8729, 55.3952), nil, nil, nil, nil, nil)
	obj:setScale(0.7606, 0.7958)
	obj:setTexture("youxi/kp1.png")
	...
	setValue(obj, "Image_Line2", 373, cc.size(976, 3), cc.p(475.7208, 336.1165), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_Line3", 374, cc.size(976, 3), cc.p(475.7208, 69.7628), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line1", 375, cc.size(976, 3), cc.p(480.0378, 197.2586), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line6", 376, cc.size(972, 105), cc.p(473.7202, 257.8553), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line4", 377, cc.size(972, 346), cc.p(473.7202, 199.781), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line5", 378, cc.size(972, 345), cc.p(473.723, 204.8339), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line7", 379, cc.size(972, 104), cc.p(473.723, 146.7682), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line9", 380, cc.size(972, 157), cc.p(473.7232, 242.7), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_line8", 381, cc.size(972, 157), cc.p(473.7205, 156.8627), nil, nil, nil, nil, false)
	obj:loadTexture("youxi/xian6.png", 0)
	bind(obj).setMargin(-12.2795, 163.6373, -31.7205, 78.3627)

	obj = ccui.ImageView:create()
	roots.Image_CardFrame_2:addChild(obj)
	roots.root.Image_Level = obj
	setValue(obj, "Image_Level", 508, cc.size(153, 38), cc.p(455.5969, 424.3689), nil, nil, nil, nil, false)
	obj:loadTexture("fangjian/fm4.png", 0)
	bind(obj).setMargin(379.0969, -44.3689, 395.9031, 405.3689)

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_upperbar = obj
	setValue(obj, "Image_upperbar", 323, cc.size(1334, 46), cc.p(667.2247, 744.3318), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_bank", 324, cc.size(57, 74), cc.p(190.4979, -21.6531), cc.p(0.4881, 0.6434), nil, nil, nil, false)
	...
	setValue(obj, "Button_Profile", 325, cc.size(122, 40), cc.p(83.1921, -29.4099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Setting", 326, cc.size(41, 43), cc.p(1201.5984, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Back", 327, cc.size(41, 43), cc.p(1265.7904, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_FAQ", 328, cc.size(41, 43), cc.p(1131.9803, 20.6166), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Share", 329, cc.size(41, 43), cc.p(1066.943, 23.5887), cc.p(0.4899, 0.5692), nil, nil, nil, false)
	...
	setValue(obj, "Button_buy", 330, cc.size(41, 43), cc.p(1000.1219, 26.5582), cc.p(0.5022, 0.6449), nil, nil, nil, false)
	...
	setValue(obj, "Image_MoneyIcon", 331, cc.size(33, 30.4771), cc.p(62.265, 28.97), cc.p(0.3486, 0.7411), nil, nil, nil, false)
	obj:setScale(1.0028, 1)
	...
	setValue(obj, "Text_MoneyCarried", 332, cc.size(98, 26), cc.p(147.6945, 23.9471), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Text_ID", 333, cc.size(62, 26), cc.p(367.9602, 24.6771), nil, nil, nil, nil, nil)
	obj:setString([[88888]])
	obj:setFontSize(20)
	...
	setValue(obj, "Image_MessageBg", 334, cc.size(351, 40), cc.p(694.0069, -23.8304), cc.p(0.4999, 0.5415), nil, 79, nil, false)
	...
	setValue(obj, "Text_IngameMessage", 335, cc.size(507, 26), cc.p(623.9014, -25.0923), nil, cc.c4b(255, 255, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_IngameMessage", 336, cc.size(24, 21), cc.p(275.3341, -27.9559), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_roomNo.", 337, cc.size(62, 28), cc.p(1148.7743, -35.5), nil, nil, nil, nil, false)
	obj:loadTexture("youxi/fangjian_mc.png", 0)
	bind(obj).setMargin(1117.7743, 67.5, 154.2257, -49.5)

	obj = ccui.Text:create()
	roots.Image_upperbar_1:addChild(obj)
	roots.root.Text_Number = obj
	setValue(obj, "Text_Number", 338, cc.size(49, 34), cc.p(1205.369, -33.2429), cc.p(0.5145, 0.4653), cc.c4b(214, 158, 0, 255), nil, nil, nil)
	obj:setString([[005]])
	obj:setFontSize(26)
	obj:enableShadow(cc.c4b(127, 127, 127, 255), cc.size(-2, -2), 0)
	obj:setTextColor(cc.c4b(214, 158, 0, 255))
	bind(obj).setMargin(1180.1586, 61.0631, 104.8414, -49.0631)

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_IngameLowerBar = obj
	setValue(obj, "Image_IngameLowerBar", 356, cc.size(1333, 197), cc.p(669.0148, 116.9155), nil, nil, 218, nil, false)
	obj:loadTexture("youxi_xia1_03.png", 0)
	bind(obj).setMargin(2.5148, 534.5845, -1.5148, 18.4155)
	roots.Image_IngameLowerBar_1 = obj

	obj = ccui.ImageView:create()
	roots.Image_IngameLowerBar_1:addChild(obj)
	roots.root.Image_TotalLinesBet = obj
	setValue(obj, "Image_TotalLinesBet", 340, cc.size(193, 50), cc.p(217.7004, 129.9063), nil, nil, nil, nil, false)
	...
	setValue(obj, "AtlasLabel_totallinesbeton", 352, cc.size(14, 18), cc.p(106.9727, 25.2817), cc.p(0.5179, 0.6692), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Up", 341, cc.size(33, 31), cc.p(-48.0443, 28.7967), nil, nil, nil, nil, false)
	...
	setValue(obj, "Button_Down", 342, cc.size(33, 31), cc.p(247.4864, 27.4133), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	...
	setValue(obj, "Image_ToralWinning", 343, cc.size(230, 40), cc.p(941.8759, 132.6091), cc.p(0.5351, 0.5351), nil, nil, nil, false)
	...
	setValue(obj, "AtlasLabel_winamount", 355, cc.size(14, 18), cc.p(118.1948, 19.3176), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Image_TotalBeting", 345, cc.size(230, 40), cc.p(627.5697, 130.9944), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "AtlasLabel_betamount", 354, cc.size(56, 18), cc.p(136.8222, 14.3275), cc.p(0.5527, 0.3322), cc.c4b(255, 165, 0, 255), nil, nil, nil)
	...
	setValue(obj, "Button_Allin", 349, cc.size(183, 55), cc.p(610.8147, 56.3509), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "Button_AutoPlay", 350, cc.size(183, 55), cc.p(931.0951, 56.351), nil, nil, nil, nil, false)
	obj:setScale(1.3, 1.3)
	...
	setValue(obj, "Button_Start", 351, cc.size(154, 132), cc.p(1217.3752, 104.118), nil, nil, nil, nil, false)
	...
	obj = ccui.ImageView:create()
	roots.Image_IngameLowerBar_1:addChild(obj)
	roots.root.Image_betperline = obj
	setValue(obj, "Image_betperline", 410, cc.size(193, 50), cc.p(221.5918, 51.3643), nil, nil, nil, nil, false)
	obj:loadTexture("yf.png", 0)
	bind(obj).setMargin(125.0918, 120.6357, 1014.9082, 26.3643)
	roots.Image_betperline_2 = obj

	obj = ccui.Button:create()
	roots.Image_betperline_2:addChild(obj)
	obj:setCapInsets(cc.rect(10, 10, 13, 11))
	roots.root.Button_Down_0 = obj
	setValue(obj, "Button_Down_0", 347, cc.size(33, 31), cc.p(247.698, 23.5369), cc.p(0.5128, 0.4495), nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/xia_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	...
	setValue(obj, "Button_Up_0", 348, cc.size(33, 31), cc.p(-47.3374, 23.9195), nil, nil, nil, nil, false)
	obj:setScale(1.5, 1.5)
	obj:loadTextureNormal("youxi/shang_an5.png", 0)
	obj:loadTextureDisabled("Default/Button_Disable.png", 0)
	obj:setTitleColor(cc.c3b(65, 65, 70))
	...
	setValue(obj, "AtlasLabel_betperline", 353, cc.size(42, 18), cc.p(108.826, 26.7275), nil, cc.c4b(255, 165, 0, 255), nil, nil, nil)
