...
function _M.create(callBackProvider)
	...
	setValue(obj, "Layer", 628, cc.size(1334, 750), nil, nil, nil, nil, nil, nil)
	roots.Layer_0 = obj

	obj = ccui.ImageView:create()
	roots.Layer_0:addChild(obj)
	roots.root.Image_1 = obj
	setValue(obj, "Image_1", 630, cc.size(1334, 750), cc.p(671.381, 375.0895), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_2", 631, cc.size(127, 106), cc.p(671.3718, 658.729), cc.p(0.5203, 0.4207), nil, nil, nil, false)
	...
	setValue(obj, "Image_3", 632, cc.size(124, 80), cc.p(512.6336, 663.717), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_4", 633, cc.size(124, 80), cc.p(357.4137, 664.0129), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_5", 634, cc.size(93, 26), cc.p(201.3271, 661.6219), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_7", 635, cc.size(133, 80), cc.p(199.1375, 468.9519), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_8", 636, cc.size(126, 80), cc.p(201.272, 371.2233), cc.p(0.5256, 0.4826), nil, nil, nil, false)
	...
	setValue(obj, "Image_9", 637, cc.size(126, 80), cc.p(518.3776, 83.8303), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_6", 638, cc.size(124.7049, 80), cc.p(193.0913, 564.2672), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_11", 639, cc.size(131, 80), cc.p(199.615, 276.1176), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_12", 640, cc.size(130, 80), cc.p(198.6949, 177.6385), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_13", 641, cc.size(133, 80), cc.p(668.2703, 81.6706), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_14", 642, cc.size(124, 80), cc.p(355.4428, 81.8798), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_15", 643, cc.size(126, 80), cc.p(1142.6708, 269.5233), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_16", 644, cc.size(93, 26), cc.p(197.0297, 86.9261), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_17", 645, cc.size(124, 80), cc.p(1140.0402, 560.9535), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml2_an.png", 0)
	...
	setValue(obj, "Image_18", 646, cc.size(131, 80), cc.p(983.0468, 82.0891), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7_an.png", 0)
	...
	setValue(obj, "Image_19", 647, cc.size(129.1848, 80), cc.p(1139.0405, 175.2021), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml4_an.png", 0)
	...
	setValue(obj, "Image_20", 648, cc.size(93, 26), cc.p(1145.0854, 77.252), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_21", 649, cc.size(131, 80), cc.p(1135.4105, 371.1009), nil, nil, nil, nil, false)
	...
	setValue(obj, "Image_22", 650, cc.size(93, 26), cc.p(1142.6672, 666.1584), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml9_an.png", 0)
	...
	setValue(obj, "Image_23", 651, cc.size(126, 80), cc.p(824.6349, 664.9493), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml6_an.png", 0)
	...
	setValue(obj, "Image_24", 652, cc.size(133, 80), cc.p(982.2574, 662.5311), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml5_an.png", 0)
	...
	setValue(obj, "Image_25", 653, cc.size(124, 80), cc.p(1138.412, 464.0044), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "Image_26", 654, cc.size(124, 80), cc.p(825.6338, 80.6707), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml3_an.png", 0)
	...
	setValue(obj, "AtlasLabel_1", 655, cc.size(56, 18), cc.p(703.541, 409.5837), nil, nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_2", 656, cc.size(28, 18), cc.p(467.9618, 165.3318), cc.p(0.5051, 0.4053), nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_3", 657, cc.size(112, 18), cc.p(741.6102, 167.8889), nil, nil, nil, nil, nil)
	...
	setValue(obj, "AtlasLabel_4", 658, cc.size(70, 18), cc.p(971.7622, 167.4369), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Button_1", 659, cc.size(17, 14), cc.p(1284.8573, 724.1099), nil, nil, nil, nil, false)
	...
	setValue(obj, "Panel_1", 660, cc.size(162.8942, 127.475), cc.p(312.3876, 208.9959), nil, nil, nil, nil, nil)
	...
	setValue(obj, "Panel_1_1", 661, cc.size(171.9986, 130.8891), cc.p(493.903, 204.4732), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	...
	roots.root.Image_30_0 = obj
	setValue(obj, "Image_30_0", 667, cc.size(150, 100), cc.p(88.7266, 59.9241), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7.png", 0)
	bind(obj).setMargin(13.7266, 20.965, 8.2721, 9.9241)

	obj = ccui.Layout:create()
	roots.Image_1_1:addChild(obj)
	roots.root.Panel_1_0 = obj
	setValue(obj, "Panel_1_0", 663, cc.size(162.8942, 127.475), cc.p(322.3877, 198.9959), nil, nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	...
	setValue(obj, "Image_30", 664, cc.size(150, 100), cc.p(73.0511, 68.5005), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7.png", 0)
	...
	setValue(obj, "Panel_1_2", 665, cc.size(167.6679, 141.0964), cc.p(757.7178, 266.5061), cc.p(0.4768, 0.446), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	bind(obj).setMargin(677.7729, 405.3227, 488.5592, 203.5809)
	roots.Panel_1_2_2 = obj

	obj = ccui.ImageView:create()
	roots.Panel_1_2_2:addChild(obj)
	roots.root.Image_30_0 = obj
	setValue(obj, "Image_30_0", 669, cc.size(150, 100), cc.p(90.894, 61.1322), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7.png", 0)
	bind(obj).setMargin(15.894, 29.9642, 1.7739, 11.1322)

	obj = ccui.Layout:create()
	roots.Image_1_1:addChild(obj)
	roots.root.Panel_1_2_0 = obj
	setValue(obj, "Panel_1_2_0", 666, cc.size(167.6679, 141.0964), cc.p(942.6775, 261.6382), cc.p(0.4768, 0.446), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 102, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	bind(obj).setMargin(862.7325, 410.1906, 303.5996, 198.713)
	roots.Panel_1_2_0_2 = obj

	obj = ccui.ImageView:create()
	roots.Panel_1_2_0_2:addChild(obj)
	roots.root.Image_30_0 = obj
	setValue(obj, "Image_30_0", 670, cc.size(150, 100), cc.p(85.5807, 65.9427), nil, nil, nil, nil, false)
	obj:loadTexture("xiaomali/ml7.png", 0)
	bind(obj).setMargin(10.5807, 25.1537, 7.0872, 15.9427)

	obj = ccui.Layout:create()
	roots.Layer_0:addChild(obj)
	roots.root.Panel_6 = obj
	setValue(obj, "Panel_6", 671, cc.size(1341.7211, 795.3879), cc.p(946.8218, 235.0389), cc.p(0.7066, 0.2968), nil, nil, nil, nil)
	obj:setTouchEnabled(true)
	setBgColor(obj, 1, 164, cc.c4b(26, 26, 26, 255), nil, nil, nil)
	bind(obj).setMargin(-1.1735, -44.3793, -6.5476, -1.0086)
	roots.Panel_6_1 = obj

	obj = ccui.ImageView:create()
	roots.Panel_6_1:addChild(obj)
	roots.root.Image_35 = obj
	setValue(obj, "Image_35", 672, cc.size(395, 102), cc.p(764.338, 448.029), nil, nil, nil, nil, false)
	obj:setScale(2, 2)
	obj:loadTexture("wining.png", 0)
	bind(obj).setMargin(566.838, 296.3589, 379.8831, 397.029)

	obj = ccui.TextAtlas:create()
	roots.Panel_6_1:addChild(obj)
	roots.root.AtlasLabel_5 = obj
	setValue(obj, "AtlasLabel_5", 673, cc.size(208, 28), cc.p(711.4988, 263.1574), nil, nil, nil, nil, nil)
	obj:setScale(3, 3)
	obj:setProperty([[50000000]], "xiaomalishuzi_03.png", 26, 28, [[0]])
	bind(obj).setMargin(607.4988, 518.2305, 526.2222, 249.1574)
